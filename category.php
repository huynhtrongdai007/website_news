            ...
            <div class="col-md-8">
             ...
             <?php 
                        ...
                        $sql = "SELECT * FROM post JOIN category as cat 
                         ...
                         ON post.author = user.user_id   where cat.category_id = {$cat_id} ORDER BY  post.post_id DESC LIMIT {$offset},{$limit_page} 
                       ";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="inner-content clearfix">
                                    <h3><a href='single.php?cid=<?php echo $row['post_id']; ?>'><?php echo $row['category_name']; ?></a></h3>
